...
class JummaTextTheme {
  ...
  static TextTheme textTheme = TextTheme(
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w400, color: Color(0xFF545454), fontFamily: 'DMSans'),
    bodySmall: const TextStyle().copyWith(fontSize: 10.0, fontWeight: FontWeight.w400, color: Color(0xFF545454), fontFamily: 'DMSans'),
